...
class LocalStore {
  ...
  Future<List<FinancialEvent>> loadEvents() async {
    ...
    return list.map((e) => FinancialEvent.fromJson(e as Map<String, dynamic>)).toList();
  }
  ...
  Future<List<DebtTransaction>> loadDebtTransactions() async {
    ...
    if (raw == null) return [];
    final list = jsonDecode(raw) as List;
    return list.map((e) => DebtTransaction.fromJson(e as Map<String, dynamic>)).toList();
  }
  ...
  Future<List<PocketAdjustmentRow>> loadPocketAdjustments() async {
    ...
    if (raw == null) return [];
    final list = jsonDecode(raw) as List;
    return list.map((e) => PocketAdjustmentRow.fromJson(e as Map<String, dynamic>)).toList();
  }
