...
enum FinancialEventType {
  ...
  pocketAdjustment,
  unknown,
  /// I4: تحويل داخلي بين محافظ المستخدم نفسه — الخصم من المحفظة المصدر
  walletTransferOut,
  /// I4: تحويل داخلي — الإضافة للمحفظة المستهدفة
  walletTransferIn,
}
...
extension FinancialEventTypeLabel on FinancialEventType {
  String get labelAr {
    switch (this) {
      ...
      case FinancialEventType.walletTransferOut:
        return 'تحويل بين المحافظ (خصم)';
      case FinancialEventType.walletTransferIn:
        return 'تحويل بين المحافظ (إضافة)';
    }
  }
}
...
class FinancialEvent {
  ...
  /// I1 — الـ walletId الخاص بهذا الحدث (ممكن يكون null للأحداث قبل migration).
  /// بعد migration، كل حدث له walletId صريح.
  final String? walletId;

  /// I4: يربط حدثَي التحويل الداخلي ببعض (كل منهما يحمل ID الآخر)
