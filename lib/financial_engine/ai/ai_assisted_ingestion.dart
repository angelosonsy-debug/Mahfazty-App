...
class AiAssistedIngestion {
  ...
  Future<void> ingestNotification(
    ...
    // القاعدة الصلبة: InstaPay مقبولة بس من مصدرين - إشعار حقيقي من
    // تطبيق InstaPay نفسه (بنتأكد بالـ package name اللي أندرويد بيدّيه،
    // مش من نص الإشعار)، أو رسالة SMS من البنك الأهلي (مصدرها في
    // ingestSms). أي إشعار من تطبيق تاني (WhatsApp، فودافون، أي حاجة)
    // بيترفض هنا **قبل ما يوصل حتى لخطوة فهم الـ AI** - مش بعدها.
